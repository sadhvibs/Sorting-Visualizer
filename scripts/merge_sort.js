function Merge(){
    ...
    document.getElementById("time-worst").innerText="O(N logN)";
    document.getElementById("time-average").innerText="O(N logN)";
    document.getElementById("time-best").innerText="O(N logN)";

    //setting the space complexity
